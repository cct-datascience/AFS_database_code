...
raw_data <- read_csv("analysis_scripts/input_data/AFS_dataset_final_03132026.csv")
...
write_csv(retained_data, "analysis_scripts/input_data/cleaned_AFS_data_03132026.csv")
...
#write_csv(removed_data, "analysis_scripts/input_data/removed_AFS_data_xxx.csv")
